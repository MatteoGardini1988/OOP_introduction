...
# The goal is to read a CSV fill and instanciate a class
Item.instantiate_from_csv()
# Here we have instantiated may object of the class which have been added to the class parameter all which is a list. SO we have
# a list, called Item.all which contains all the classes we have instantiarted so far.
print(Item.all)

# How to call a static method? You can call it from the class as a normal function!
print(Item.is_integer(4.5))  # False
print(Item.is_integer(4.0))  # True
